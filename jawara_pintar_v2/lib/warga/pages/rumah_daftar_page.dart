...
import '../components/tabel/rumah/rumah_list.dart';
        ...
        children: [
          ...
          ConstrainedBox(
            constraints: BoxConstraints(
              maxHeight: MediaQuery.of(context).size.height * 0.2, // Maks 20% layar
            ),
            child: SingleChildScrollView(
              // Tambahkan scroll jika filternya banyak
              child: Wrap(
                spacing: 8,
                runSpacing: 8,
                children: _filters.entries.map((entry) {
                  return Chip(
                    // KUNCI PERBAIKAN: Batasi lebar teks di dalam chip
                    label: ConstrainedBox(
                      constraints: BoxConstraints(
                        maxWidth: MediaQuery.of(context).size.width * 0.6, // Maks 60% layar
                      ),
                      child: Text(
                        "${entry.key}: ${entry.value}",
                        style: const TextStyle(fontSize: 12),
                        overflow: TextOverflow.ellipsis, // Potong teks dgn ...
                        maxLines: 1,
                      ),
                    ),
                    backgroundColor: Colors.blue.withOpacity(0.1),
